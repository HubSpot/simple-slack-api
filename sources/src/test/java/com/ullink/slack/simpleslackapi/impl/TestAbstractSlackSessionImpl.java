...
public class TestAbstractSlackSessionImpl
{
    ...
    private class TestSlackSessionImpl extends AbstractSlackSessionImpl
    {
        ...
        public void connect()
        {
            channels.put("channelid1",new SlackChannel("channelid1", "testchannel1", getUsersForChannel("channelid1"), "topicchannel1", "topicchannel1", false, false, false));
            channels.put("channelid2",new SlackChannel("channelid2", "testchannel2", getUsersForChannel("channelid2"), "topicchannel2", "topicchannel2", false, false, false));
            channels.put("channelid3",new SlackChannel("channelid3", "testchannel3", getUsersForChannel("channelid3"), "topicchannel3", "topicchannel3", false, false, false));
            channels.put("channelid4",new SlackChannel("channelid4", "testchannel4", getUsersForChannel("channelid4"), "topicchannel4", "topicchannel4", false, false, false));
            channels.put("channelid5",new SlackChannel("channelid5", "testchannel5", getUsersForChannel("channelid5"), "topicchannel5", "topicchannel5", false, false, false));
